(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 17020))
 (global $~lib/memory/__heap_base i32 (i32.const 17020))
 (memory $0 1)
 ...
 (data (i32.const 108) "<\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\1e\00\00\00W\00a\00s\00m\00 \00B\00y\00 \00E\00x\00a\00m\00p\00l\00e\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (data (i32.const 608) "\03\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (export "addWasmByExample" (func $export:assembly/index/addWasmByExample))
 (start $~start)
 ...
 (func $assembly/index/addWasmByExample (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $export:assembly/index/addWasmByExample (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store
  local.get $0
  call $assembly/index/addWasmByExample
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
